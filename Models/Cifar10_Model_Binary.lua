...
model:add(cudnnBinarySpatialConvolution(3, 64, 5, 5 ))
--model:add(cudnn.SpatialMaxPooling(2, 2))
model:add(nn.SpatialBatchNormalization(64))
model:add(nn.HardTanh())
model:add(BinarizedNeurons(opt.stcNeurons))

model:add(cudnnBinarySpatialConvolution(64, 64, 3, 3))
model:add(cudnn.SpatialMaxPooling(2, 2))
model:add(nn.SpatialBatchNormalization(64))
model:add(nn.HardTanh())
model:add(BinarizedNeurons(opt.stcNeurons))

model:add(cudnnBinarySpatialConvolution(64, 128, 3, 3))
--model:add(cudnn.SpatialMaxPooling(2, 2))
model:add(nn.SpatialBatchNormalization(128))
model:add(nn.HardTanh())
model:add(BinarizedNeurons(opt.stcNeurons))

model:add(cudnnBinarySpatialConvolution(128, 128, 3, 3))
--model:add(cudnn.SpatialMaxPooling(2, 2))
model:add(nn.SpatialBatchNormalization(128))
model:add(nn.HardTanh())
model:add(BinarizedNeurons(opt.stcNeurons))
...
model:add(cudnnBinarySpatialConvolution(128, 256, 3, 3))
model:add(nn.SpatialBatchNormalization(256))
model:add(nn.HardTanh())
model:add(BinarizedNeurons(opt.stcNeurons))

model:add(cudnnBinarySpatialConvolution(256, 256, 3, 3))
model:add(nn.SpatialBatchNormalization(256))
model:add(nn.HardTanh())
model:add(BinarizedNeurons(opt.stcNeurons))

model:add(cudnnBinarySpatialConvolution(256, 512, 2,2))
...
--model:add(BinaryLinear(512,1024))
